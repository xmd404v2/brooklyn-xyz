...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={"dark " + orbitron.variable}>
      <head>
        <meta name="fc:frame" content='{"version":"next","imageUrl":"https://brooklyn-xyz.vercel.app/assets/brooklyn_sprite_excited.png","button":{"title":"Play Cipher City","action":{"type":"launch_frame","name":"Cipher City","url":"https://brooklyn-xyz.vercel.app","splashImageUrl":"https://brooklyn-xyz.vercel.app/assets/brooklyn_sprite_excited.png","splashBackgroundColor":"#10121a"}}}' />
      </head>
